...
from urls.serializers import UrlSerializer, UrlTrackSerializer, GraphSerializer, RecycleUrlSerializer
...
class RecycleUrlRestore(RetrieveAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            Url.objects.create(name=recycled_url.name,slug=recycled_url.slug,shortened=recycled_url.shortened,location=recycled_url.location,creator=recycled_url.creator)
            recycled_url.delete()
